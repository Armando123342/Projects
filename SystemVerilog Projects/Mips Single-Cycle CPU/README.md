Developed a Mips Single-Cycle CPU in SystemVerilog. This model of the single-cycle MIPS processor divides the machine into two major units: the control unit and the datapath.
